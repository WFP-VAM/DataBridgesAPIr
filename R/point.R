...
#' @field coordinateSequence  \link{CoordinateSequence} [optional]
...
Point <- R6::R6Class(
  ...
  public = list(
    ...
    `y` = NULL,
    `z` = NULL,
    `_field_list` = c("area", "boundary", "boundaryDimension", "centroid", "coordinate", "coordinateSequence", "coordinates", "dimension", "envelope", "envelopeInternal", "factory", "geometryType", "interiorPoint", "isEmpty", "isRectangle", "isSimple", "isValid", "length", "m", "numGeometries", "numPoints", "ogcGeometryType", "pointOnSurface", "precisionModel", "srid", "userData", "x", "y", "z"),
    ...
    #' @export
    initialize = function(`area` = NULL, `boundary` = NULL, `boundaryDimension` = NULL, `centroid` = NULL, `coordinate` = NULL, `coordinateSequence` = NULL, `coordinates` = NULL, `dimension` = NULL, `envelope` = NULL, `envelopeInternal` = NULL, `factory` = NULL, `geometryType` = NULL, `interiorPoint` = NULL, `isEmpty` = NULL, `isRectangle` = NULL, `isSimple` = NULL, `isValid` = NULL, `length` = NULL, `m` = NULL, `numGeometries` = NULL, `numPoints` = NULL, `ogcGeometryType` = NULL, `pointOnSurface` = NULL, `precisionModel` = NULL, `srid` = NULL, `userData` = NULL, `x` = NULL, `y` = NULL, `z` = NULL, additional_properties = NULL, ...) {
      if (!is.null(`area`)) {
      ...
      if (!is.null(`coordinateSequence`)) {
        stopifnot(R6::is.R6(`coordinateSequence`))
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`coordinateSequence`)) {
        PointObject[["coordinateSequence"]] <-
          self$`coordinateSequence`$toJSON()
      }
      ...
      if (!is.null(self$`geometryType`)) {
        PointObject[["geometryType"]] <-
          self$`geometryType`
      }
      if (!is.null(self$`interiorPoint`)) {
        PointObject[["interiorPoint"]] <-
      ...
      if (!is.null(self$`isRectangle`)) {
        PointObject[["isRectangle"]] <-
          self$`isRectangle`
      }
      if (!is.null(self$`isSimple`)) {
        PointObject[["isSimple"]] <-
          self$`isSimple`
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`coordinateSequence`)) {
        `coordinatesequence_object` <- CoordinateSequence$new()
        `coordinatesequence_object`$fromJSON(jsonlite::toJSON(this_object$`coordinateSequence`, auto_unbox = TRUE, digits = NA))
    ...
    toJSONString = function() {
      jsoncontent <- c(
        ...
        if (!is.null(self$`coordinateSequence`)) {
          ...
          %s
          ',
          jsonlite::toJSON(self$`coordinateSequence`$toJSON(), auto_unbox = TRUE, digits = NA)
          )
        },
        if (!is.null(self$`coordinates`)) {
          sprintf(
